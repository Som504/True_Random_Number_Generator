...
HD_PWD='D:/SUMMER 2025/Verilog_INTERN/TRNG/TRNG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log neoTRNG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source neoTRNG.tcl
